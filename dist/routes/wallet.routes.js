...
router.post("/", (0, validations_1.validate)(wallet_validation_1.createWalletSchema), walletController.create);
router.put("/:id", (0, validations_1.validate)(wallet_validation_1.updateWalletSchema), walletController.update);
