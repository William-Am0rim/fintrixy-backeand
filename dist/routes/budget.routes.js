...
router.post("/", (0, validations_1.validate)(budget_validation_1.createBudgetSchema), budgetController.create);
router.put("/:id", (0, validations_1.validate)(budget_validation_1.updateBudgetSchema), budgetController.update);
